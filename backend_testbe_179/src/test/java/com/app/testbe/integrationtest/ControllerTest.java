package com.app.testbe.integrationtest;
...
import com.app.testbe.SpringApp;
...
class ControllerTest {
  ...
  given()
   ...
   given()
            .when()
            .get("/testbe/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/testbe/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM testbe.PetService");
    jdbcTemplate.execute("DELETE FROM testbe.PetOwner");
    jdbcTemplate.execute("DELETE FROM testbe.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM testbe.Manager");
    jdbcTemplate.execute("DELETE FROM testbe.Document");
    jdbcTemplate.execute("DELETE FROM testbe.Pet");
     jdbcTemplate.execute("DELETE FROM testbe.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM testbe.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM testbe.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM testbe.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM testbe.PetCareCenterPets");
